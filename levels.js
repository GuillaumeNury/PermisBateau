const levels = [
    ...
    ...parseExercices(
        ...
        73;188;328;440;Pasasge à sens unique - Attendre
        75;184;422;440;Pasasge à sens unique - Passer
        69;146;558;298;Pasasge à double sens
        67;142;712;303;Attendre les instructions
        177;127;590;521;Possibilité de passer hors chenal`,
        'Signaux portuaires',
        'memento-cotier-2.jpg'
    ),
    { type: "text", question: "Signal de détresse", solution: "MAYDAY", choices: ["MAYDAY", "PAN PAN", "SECURITE"] },
    { type: "text", question: "Signal d'urgence", solution: "PAN PAN", choices: ["MAYDAY", "PAN PAN", "SECURITE"] },
    { type: "text", question: "Signal de sécurité", solution: "SECURITE", choices: ["MAYDAY", "PAN PAN", "SECURITE"] },
    { type: "text", question: "Signal si homme à la mer", solution: "MAYDAY", choices: ["MAYDAY", "PAN PAN", "SECURITE"] },
    { type: "text", question: "Signal si chavirage", solution: "MAYDAY", choices: ["MAYDAY", "PAN PAN", "SECURITE"] },
    { type: "text", question: "Signal si danger grave et imminent", solution: "MAYDAY", choices: ["MAYDAY", "PAN PAN", "SECURITE"] },
    { type: "text", question: "Signal si la sécurité du navire et/ou personne est en jeu", solution: "PAN PAN", choices: ["MAYDAY", "PAN PAN", "SECURITE"] },
    { type: "text", question: "Signal s'il y a un blessé", solution: "PAN PAN", choices: ["MAYDAY", "PAN PAN", "SECURITE"] },
    { type: "text", question: "Signal si remorquage", solution: "PAN PAN", choices: ["MAYDAY", "PAN PAN", "SECURITE"] },
    { type: "text", question: "Signal si la météo s'aggrave", solution: "SECURITE", choices: ["MAYDAY", "PAN PAN", "SECURITE"] },
    { type: "text", question: "Signal si on rencontre une épave", solution: "SECURITE", choices: ["MAYDAY", "PAN PAN", "SECURITE"] },
    { type: "text", question: "Si on croise un signal \"Plongée sous-marine\", il faut passer à", solution: "100m", choices: ["50m", "100m", "150m", "200m"] },
    { type: "text", question: "Anticyclone", solution: "Hautes pressions", choices: ["Hautes pressions", "Basses pressions"] },
    { type: "text", question: "Dépression", solution: "Basses pressions", choices: ["Hautes pressions", "Basses pressions"] },
    { type: "text", question: "Brise thermique", solution: "De jour vers la terre, de nuit vers la mer", choices: ["De jour vers la terre, de nuit vers la mer", "De jour vers la mer, de nuit vers la terre"] },
    { type: "text", question: "Bulletin Météo Spécial", solution: "Sur le canal 16 à partir de force 7", choices: ["Sur le canal 8 à partir de force 7", "Sur le canal 8 à partir de force 8", "Sur le canal 16 à partir de force 7", "Sur le canal 16 à partir de force 8"] },
];
...
function parseExercices(raw, category, image) {
    return raw.replace(/    /g, '').split('\n')
        .map(line => line.split(';'))
        .map(([width, height, left, top, solution]) => ({ type: "image", width, height, left, top, solution, category, image }));
}
